...
public class Evento extends Compromissos{
    ...
    public Evento(String data, String hora, int duracao, int indentificador, String tipoIdentificador, int multiplicador, boolean adiavel, String local, String tipo, int grauPrioridade) {
